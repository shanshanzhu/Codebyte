///this version will bump irregularly when user type in msg very fast!
...
var ajaxObj = {url:'https://api.parse.com/1/classes/chats',dataType: 'json',contentType:'application/json'};
var ajaxSendObj = {type: 'GET', data:{"order":"-createdAt"}, error: errorFunc};
